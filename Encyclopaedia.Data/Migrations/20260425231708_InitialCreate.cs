...
namespace Encyclopaedia.Data.Migrations
{
    ...
    // Cette classe représente la migration initiale pour créer la structure de la base de données.
    // Add-migration cree la classe pour les migrations, et update-database applique la migration à la base de données.
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DomainId = table.Column<int>(type: "int", nullable: false),
                    LanguageId = table.Column<int>(type: "int", nullable: false),
                    DomainTranslationId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
